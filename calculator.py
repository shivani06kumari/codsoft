...
# squareroot
button_sqrt=tk.Button(master=frame,text="√",padx=15,pady=5,width=3,command=sqrt)
button_sqrt.grid(row=6,column=1,pady=2)
...
# ! button
button_clear=tk.Button(master=frame,text="!",padx=15,pady=5,width=3,command=fact)
button_clear.grid(row=6,column=2,pady=2)



# <_ button
button_unknown=tk.Button(master=frame,text="<_",padx=15,pady=5,width=3,command=lambda:myclick('<'))
button_unknown.grid(row=7,column=0,pady=2)

#Equal button
button_equal=tk.Button(master=frame,text="=",padx=15,pady=5,width=12,command=equal)
button_equal.grid(row=7,column=1,columnspan=2,pady=2)
